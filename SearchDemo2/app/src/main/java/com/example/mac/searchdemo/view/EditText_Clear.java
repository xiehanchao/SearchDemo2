...
public class EditText_Clear extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init() {
        ...
        if(android.os.Build.VERSION.SDK_INT >= 21){
            clearDrawable =  getResources().getDrawable(R.drawable.clear,getContext().getTheme());
            searchDrawable =  getResources().getDrawable(R.drawable.search,getContext().getTheme());
        } else {
            clearDrawable =  getResources().getDrawable(R.drawable.clear);
            searchDrawable =  getResources().getDrawable(R.drawable.search);
        }
//        searchDrawable.setBounds(50,0,50+searchDrawable.getIntrinsicWidth(),searchDrawable.getIntrinsicHeight());
